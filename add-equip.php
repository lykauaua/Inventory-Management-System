...
<?php
    ...
    $_SESSION['redirect_to'] = 'add-equip.php';
    $user = $_SESSION['user'];
            ...
            <div class="contentRed"></div> -->
                ...
                <div class="row">
                    <div class="column column-12">
                        <h2 class="AddUserHeader"><i class = "fas fa-plus"></i> Add Equipment</h2>
                        <div class="content-main">
                            <div class="userAddFormContainer">
                              <form action="database/addE.php" method="POST" class= "appForm" id="appForm" enctype="multipart/form-data">

                            <div class="appFormInputContainer">
                                <label for="serial_num" class="appFormAtt" >Serial No.</label>
                                <input type="number" id="serial_num" name="serial_num" placeholder="Enter the serial no. of the equipment.." class="appFormInput">
                            </div>

                            <div class="appFormInputContainer">
                                <label for="equip_name" class="appFormAtt" >Equipment Name</label>
                                <input type="text" id="equip_name" name="equip_name" placeholder="Enter equipment name.. eg. 'Reagent Flasks' " class="appFormInput" required>
                            </div>
                            <div class="appFormInputContainer">
                                <label for="quantity" class="appFormAtt" >Quantity</label>
                                <input type="number" id="quantity" name="quantity" placeholder="Enter the quantity of the equipment" class="appFormInput" >
                            </div>
                            <div class="appFormInputContainer">
                                <label for="status" class="appFormAtt" >Status</label>
                                <select class = "dropDownStatus" name="status" id="status">
                                    <option selected disabled>Choose a status</option>
                                    <option style="padding: 4px 4px; background: lightgreen;">Serviceable</option>
                                    <option style="padding: 4px 4px; background: orange;">Not Serviceable</option>  
                                </select>
                            </div>
                            <div class="appFormInputContainer">
                           ...
                           <?php 
                                if(isset($_SESSION['response'])){ 
                                    ...
                                    <?php if($is_success): ?>
                                        Swal.fire({
                                            title: "Success!",
                                            text: "Equipment has been added to the system.",
